...
if(tortoiseLocationX==500&&tortoiseLocationY==290){
	JOptionPane.showMessageDialog(null, "Go and find the next clue at the left eye of the skull!");
	}
		// 7. Give the user subsequent clues at different locations on the image
if(tortoiseLocationX==140&&tortoiseLocationY==40){
	JOptionPane.showMessageDialog(null, "THE NEXT CLUE IS WITH THE PIRATE. ON HIS HAT OF CROSSBONES, TO BE EXACT... GOOD LUCK!");}
	if(tortoiseLocationX==400&&tortoiseLocationY==240);{
	JOptionPane.showMessageDialog(null, "You found the treasure!Congratulations!");}
}
