...
void setup() {
  ...
  PImage friends = loadImage("smiley face emoji.jpg");  // 2. Change this to match the name of your photo. 
  size(1000,1000);
   friends.resize(1000,1000);
  // 3. Set your friends as the background. 
background (friends);
// 4. Find an image of a mustache, and drop it onto this sketch. 
  mustache = loadImage("mustache.png.gif"); // 5. Change this to match your file name.
}
